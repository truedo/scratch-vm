...
/*
        ...
        // 프로그램의 실행 상태 값
        this.runtime.on('SCRIPT_GLOW_ON', () => {
            //"// 플래그 초기화"
            console.log("SCRIPT_GLOW_ON");
        });
        this.runtime.on('SCRIPT_GLOW_OFF', () => {
            //"// 플래그 초기화"
            console.log("SCRIPT_GLOW_OFF");
        });

        this.runtime.on('BLOCK_GLOW_ON', () => {
            //"// 플래그 초기화"
            console.log("BLOCK_GLOW_ON");
        });
        this.runtime.on('BLOCK_GLOW_OFF', () => {
            //"// 플래그 초기화"
            console.log("BLOCK_GLOW_OFF");
        });


        this.runtime.on('TURBO_MODE_ON', () => {
            //"// 플래그 초기화"
            console.log("TURBO_MODE_ON");
        });
        this.runtime.on('TURBO_MODE_OFF', () => {
            //"// 플래그 초기화"
            console.log("TURBO_MODE_OFF");
        });
        ...
        this.runtime.on('STOP_FOR_TARGET', () => {
            //"// 플래그 초기화"
            console.log("STOP_FOR_TARGET");
        });


        this.runtime.on('VISUAL_REPORT', () => {
            //"// 플래그 초기화"
            console.log("VISUAL_REPORT");
        });
        ...
        this.runtime.on('TOOLBOX_EXTENSIONS_NEED_UPDATE', () => {
            //"// 플래그 초기화"
            console.log("TOOLBOX_EXTENSIONS_NEED_UPDATE");
        });

        this.runtime.on('TARGETS_UPDATE', () => {
            //"// 플래그 초기화"
            console.log("TARGETS_UPDATE");
        });

        this.runtime.on('MONITORS_UPDATE', () => {
            //"// 플래그 초기화"
            console.log("MONITORS_UPDATE");
        });

        // this.runtime.on('BLOCK_DRAG_UPDATE', () => {
        //     //"// 플래그 초기화"
        //     console.log("BLOCK_DRAG_UPDATE");
        // });

        this.runtime.on('BLOCK_DRAG_END', () => {
            //"// 플래그 초기화"
        ...
        //
        this.runtime.on('EXTENSION_ADDED', () => {
            //"// 플래그 초기화"
            console.log("EXTENSION_ADDED");
        });


        this.runtime.on('EXTENSION_FIELD_ADDED', () => {
            //"// 플래그 초기화"
            console.log("EXTENSION_FIELD_ADDED");
        });
        ...
        this.runtime.on('PERIPHERAL_LIST_UPDATE', () => {
            //"// 플래그 초기화"
            console.log("PERIPHERAL_LIST_UPDATE");
        });

        this.runtime.on('USER_PICKED_PERIPHERAL', () => {
            //"// 플래그 초기화"
            console.log("USER_PICKED_PERIPHERAL");
        });

        this.runtime.on('PERIPHERAL_CONNECTED', () => {
            //"// 플래그 초기화"
            console.log("PERIPHERAL_CONNECTED");
        });

        this.runtime.on('PERIPHERAL_DISCONNECTED', () => {
            //"// 플래그 초기화"
            console.log("PERIPHERAL_DISCONNECTED");
        });


        this.runtime.on('PERIPHERAL_REQUEST_ERROR', () => {
            //"// 플래그 초기화"
            console.log("PERIPHERAL_REQUEST_ERROR");
        });

        this.runtime.on('PERIPHERAL_CONNECTION_LOST_ERROR', () => {
            //"// 플래그 초기화"
            console.log("PERIPHERAL_CONNECTION_LOST_ERROR");
        });



        this.runtime.on('PERIPHERAL_SCAN_TIMEOUT', () => {
            //"// 플래그 초기화"
            console.log("PERIPHERAL_SCAN_TIMEOUT");
        });

        this.runtime.on('MIC_LISTENING', () => {
            //"// 플래그 초기화"
            console.log("MIC_LISTENING");
        });



        this.runtime.on('BLOCKSINFO_UPDATE', () => {
            //"// 플래그 초기화"
            console.log("BLOCKSINFO_UPDATE");
        });

        this.runtime.on('RUNTIME_STARTED', () => {
            //"// 플래그 초기화"
            console.log("RUNTIME_STARTED");
        });


        this.runtime.on('RUNTIME_DISPOSED', () => {
            //"// 플래그 초기화"
            console.log("RUNTIME_DISPOSED");
        });

        this.runtime.on('BLOCKS_NEED_UPDATE', () => {
            //"// 플래그 초기화"
            console.log("BLOCKS_NEED_UPDATE");
        });
*/
